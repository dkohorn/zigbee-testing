...
#define INSTALLCODE_POLICY_ENABLE       false                                   /* enable the install code policy for security */       //Adds security for deployment with a predifined code, code is install on devices before starting zigbee stack
